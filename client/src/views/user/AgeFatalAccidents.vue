<template>
    <div class="age-analysis-container">
        <div class="page-header">
            <h1>Yaş Gruplarına Göre Ölümlü İş Kazaları Analizi</h1>
            <p class="subtitle">2019-2023 yılları arası yaş bazlı ölümlü iş kazası verileri</p>
        </div>
        ...
        <div class="chart-container" v-if="selectedAge === 'all' && !loading">
            <h2>Yaş Bazlı Ölüm Karşılaştırması</h2>
    ...
    setup() {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const response = await axios.get('/api/fatal-work-accidents-by-age-user', { params })
        ...
        const updateMainChart = () => {
            ...
            tableData.value.forEach(item => {
                ...
                ageData[item.age].accident += item.work_accident_fatalities || 0
                ageData[item.age].disease += item.occupational_disease_fatalities || 0
