<template>
    <div class="month-analysis-container">
        ...
        <div class="page-header">
            <h1>Aylara Göre İş Kazaları Analizi</h1>
            <p class="subtitle">2019-2023 yılları arası aylık iş kazası verileri</p>
        </div>
        ...
        <div class="chart-container" v-if="selectedMonth === 'all' && !loading">
            <h2>Ay Bazlı Kaza Karşılaştırması</h2>
    ...
    setup() {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const response = await axios.get('/api/work-accidents-by-month-user', { params })
