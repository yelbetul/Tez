<template>
    <div class="disability-analysis-container">
        <div class="page-header">
            <h1>Aylara Göre Geçici İş Göremezlik Analizi</h1>
            <p class="subtitle">Aylık geçici iş göremezlik ve meslek hastalığı verileri</p>
        </div>
        ...
        <div class="chart-container" v-if="selectedMonth === 'all' && !loading">
            <h2>Ay Bazlı İş Göremezlik Dağılımı</h2>
        ...
        <div class="detail-charts" v-if="selectedMonth !== 'all' && !loading">
            <div class="chart-container">
                <h2>{{ selectedMonth }} - Yıllara Göre İş Göremezlik</h2>
    ...
    setup() {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const response = await axios.get('/api/temporary-disability-days-by-month-user', { params })
        ...
        const updateMainChart = () => {
            ...
            tableData.value.forEach(item => {
                ...
                monthData[month].unfit += calculateUnfit(item)
                monthData[month].disease += item.occupational_disease_cases || 0
            ...
            mainSeries.value = [{
                ...
                data: availableMonths.value.map(month => ({
                    ...
                    y: selectedMetric.value === 'total' ? monthData[month].total :
                        selectedMetric.value === 'unfit' ? monthData[month].unfit :
