<template>
    ...
    <WorkAccidentsByAges v-if="modal_visible" :visible="modal_visible" :data="selected_code" :state="state"
        @close="closeModal" />
...
import WorkAccidentsByAges from '@/components/panel/tables/WorkAccidentsByAges.vue';
import ImportData from '@/components/panel/tables/import/WorkAccidentByAges.vue';
export default {
    components: {
        PageNavbar,
        WorkAccidentsByAges,
    ...
    data() {
        return {
            navbarData: {
                title: 'Yaşlara Göre İş Kazaları',
    ...
    methods: {
        ...
        deleteData(item) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete('https://iskazalarianaliz.com/api/work-accidents-by-age/delete/' + item.id)
                        .then(res => {
                            if (res.data.success) {
                                this.initializeAuth()
                                Swal.fire({
        ...
        downloadExcel() {
            ...
            const worksheet = workbook.addWorksheet('İş Kazaları Yaşlara Göre');
            ...
            workbook.xlsx.writeBuffer().then((buffer) => {
                ...
                a.href = url;
                a.download = 'Is_Kazalari_Yaslara_Gore.xlsx';
        ...
        async initializeAuth() {
            ...
            try {
                ...
                const response = await axios.get('https://iskazalarianaliz.com/api/work-accidents-by-age')
