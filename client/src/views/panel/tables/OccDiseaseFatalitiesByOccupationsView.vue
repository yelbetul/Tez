<template>
    ...
    <OccDiseaseFatalitiesByOccupations v-if="modal_visible" :visible="modal_visible" :data="selected_code"
...
import OccDiseaseFatalitiesByOccupations from '@/components/panel/tables/OccDiseaseFatalitiesByOccupations.vue';
import ImportData from '@/components/panel/tables/import/OccDiseaseFatalitiesByOccupations.vue';
export default {
    components: {
        PageNavbar,
        OccDiseaseFatalitiesByOccupations,
        ImportData
    },
    setup() {
    ...
    data() {
        return {
            navbarData: {
                title: 'Mesleklere Göre Meslek Hastalığı',
    ...
    methods: {
        ...
        deleteData(item) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete('https://iskazalarianaliz.com/api/occ-disease-fatalities-by-occupation/delete/' + item.id)
                        .then(res => {
                            if (res.data.success) {
                                this.initializeAuth()
                                Swal.fire({
        ...
        downloadExcel() {
            ...
            workbook.xlsx.writeBuffer().then((buffer) => {
                ...
                a.href = url;
                a.download = 'Meslege_Gore_Meslek_Hastaligi.xlsx';
        ...
        async initializeAuth() {
            ...
            try {
                ...
                const response = await axios.get('https://iskazalarianaliz.com/api/occ-disease-fatalities-by-occupation')
