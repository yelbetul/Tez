<template>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Lorem.</td>
                        <td>
                            <i @click="updateInjuryType" class="fa-solid fa-pen-to-square"></i>
                            <i @click="deleteInjuryType" class="fa-solid fa-trash-can"></i>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <InjuryType v-if="modal_visible" :visible="modal_visible" :state="state" @close="closeModal" />
</template>
