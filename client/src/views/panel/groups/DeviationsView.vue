<template>
    <div class="page-container">
        ...
        <div class="navbar-buttons">
            <span @click="newDeviationCode"><i class="fa-solid fa-plus"></i> Yeni Sapma Kodu</span>
    ...
    <DeviationCode v-if="modal_visible" :visible="modal_visible" :data="selected_deviation" :state="state"
        @close="closeModal" />
</template>
