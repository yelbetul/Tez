<template>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Lorem.</td>
                        <td>
                            <i @click="updateSpecialActivity" class="fa-solid fa-pen-to-square"></i>
                            <i @click="deleteSpecialActivity" class="fa-solid fa-trash-can"></i>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <SpecialActivity v-if="modal_visible" :visible="modal_visible" :state="state" @close="closeModal" />
</template>
