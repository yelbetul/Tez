<template>
    <div class="page-container">
        ...
        <div class="navbar-buttons">
            <span @click="newSectorCode"><i class="fa-solid fa-plus"></i> Yeni Sektör Kodu</span>
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <tr v-for="item in sector_codes" :key="item.id">
                        ...
                        <td>
                            <i @click="updateSectorCode(item)" class="fa-solid fa-pen-to-square"></i>
                            <i @click="deleteSectorCode(item)" class="fa-solid fa-trash-can"></i>
                        </td>
                    </tr>
                </tbody>
            </table>
...
<script>
import SectorCode from '@/components/panel/groups/SectorCode.vue';
    ...
    methods: {
        ...
        deleteSectorCode(item) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete('https://iskazalarianaliz.com/api/sector-codes/delete/' + item.id)
                        .then(res => {
                            if (res.data.success) {
                                this.initializeAuth()
                                Swal.fire({
                                    title: 'Silindi!',
                                    text: 'Sektör kodu başarıyla silindi.',
                                    icon: 'success',
                                });
                            }
                        })
        ...
        downloadExcel() {
            ...
            worksheet.columns = [
                ...
                { header: 'Alt Grup Kodu', key: 'sub_group_code', width: 10 },
                { header: 'Alt Grup Adı', key: 'sub_group_name', width: 35 },
                { header: 'Kod', key: 'pure_code', width: 10 },
                { header: 'Ad', key: 'pure_name', width: 35 },
            ];
            ...
            workbook.xlsx.writeBuffer().then((buffer) => {
                ...
                a.href = url;
                a.download = 'Sektor_Kodlari.xlsx';
        ...
        async initializeAuth() {
            ...
            axios.get('https://iskazalarianaliz.com/api/sector-codes')
                .then(res => {
                    this.sector_codes = res.data.data
                })
        },
    },
    created() {
