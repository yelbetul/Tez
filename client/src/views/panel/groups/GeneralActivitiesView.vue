<template>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Lorem.</td>
                        <td>
                            <i @click="updateGeneralActivity" class="fa-solid fa-pen-to-square"></i>
                            <i @click="deleteGeneralActivity" class="fa-solid fa-trash-can"></i>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <GeneralActivity v-if="modal_visible" :visible="modal_visible" :state="state" @close="closeModal" />
</template>
