<template>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Lorem ipsum.</td>
                        <td>
                            <i @click="updateOccupationCode" class="fa-solid fa-pen-to-square"></i>
                            <i @click="deleteOccupationCode" class="fa-solid fa-trash-can"></i>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <OccupationCode v-if="modal_visible" :visible="modal_visible" :state="state" @close="closeModal" />
</template>
