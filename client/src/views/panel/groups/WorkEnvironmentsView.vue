<template>
    <div class="page-container">
        ...
        <div class="navbar-buttons">
            <span @click="newWorkEnvironment"><i class="fa-solid fa-plus"></i> Yeni Çalışma Ortamı Kodu</span>
        </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Lorem.</td>
                        <td>
                            <i @click="updateWorkEnvironment" class="fa-solid fa-pen-to-square"></i>
                            <i @click="deleteWorkEnvironment" class="fa-solid fa-trash-can"></i>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <WorkEnvironment v-if="modal_visible" :visible="modal_visible" :state="state" @close="closeModal" />
</template>
