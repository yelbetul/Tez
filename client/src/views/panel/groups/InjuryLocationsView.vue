<template>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Lorem.</td>
                        <td>
                            <i @click="updateInjuryLocation" class="fa-solid fa-pen-to-square"></i>
                            <i @click="deleteInjuryLocation" class="fa-solid fa-trash-can"></i>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <InjuryLocation v-if="modal_visible" :visible="modal_visible" :state="state" @close="closeModal" />
</template>
