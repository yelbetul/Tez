        ...
        <div class="table-container">
            <div class="table">
                <table>
                    ...
                    <tbody>
                        <tr v-for="item in employee_times" :key="item.id">
                            <td>{{ item.code }}</td>
            ...
            <EmployeeTimes v-if="modal_visible" :visible="modal_visible" :state="state" :data="update_time"
...
<script>
import EmployeeTimes from '@/components/panel/groups/EmployeeTimes.vue';
    ...
    methods: {
        ...
        deleteTimeCode(item) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete('https://iskazalarianaliz.com/api/employee-employment-durations/delete/' + item.id)
                        .then(res => {
                            if (res.data.success) {
                                this.initializeAuth()
                            }
        ...
        async initializeAuth() {
            ...
            axios.get('https://iskazalarianaliz.com/api/employee-employment-durations')
                .then(res => {
                    this.employee_times = res.data.data
                })
        },
    },
    created() {
