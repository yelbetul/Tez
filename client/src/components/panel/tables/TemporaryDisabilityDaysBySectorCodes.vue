...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            if (this.state == 'new') {
                axios.post('https://iskazalarianaliz.com/api/temporary-disability-day-by-sector/store', this.formData)
                    .then(res => {
                ...
                axios.put('https://iskazalarianaliz.com/api/temporary-disability-day-by-sector/update/' + this.formData.id, this.formData)
                    .then(res => {
                        if (!res.data.success) {
                            this.error = true;
                            this.errorMessage = res.data.message;
