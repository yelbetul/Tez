<template>
    <div v-if="visible" class="modal-overlay" @click.self="closeModal">
        <div class="sector-codes-modal">
            ...
            <h2>Çalışma Süresine Göre İş Kazası Verisi Aktar</h2>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            axios.post('https://iskazalarianaliz.com/api/accidents-and-fatalities-by-employer-durations/import', formData, {
                headers: {
