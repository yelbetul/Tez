<template>
    <div v-if="visible" class="modal-overlay" @click.self="closeModal">
        <div class="sector-codes-modal">
            ...
            <h2>Yaranın Vücuttaki Yerine Göre İş Kazası Verisi Aktar</h2>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            axios.post('https://iskazalarianaliz.com/api/accidents-and-fatalities-by-injury-locations/import', formData, {
                headers: {
