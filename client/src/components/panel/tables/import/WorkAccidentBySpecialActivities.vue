<template>
    <div v-if="visible" class="modal-overlay" @click.self="closeModal">
        <div class="sector-codes-modal">
            ...
            <h2>Özel Faaliyete Göre İş Kazası Verisi Aktar</h2>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            axios.post('https://iskazalarianaliz.com/api/accidents-and-fatalities-by-special-activities/import', formData, {
                headers: {
