<template>
    <div v-if="visible" class="modal-overlay" @click.self="closeModal">
        <div class="sector-codes-modal">
            ...
            <h2>Çalışma Süresine Göre Meslek Hastalığı Verisi Aktar</h2>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            axios.post('https://iskazalarianaliz.com/api/occ-disease-fatalities-by-employer-durations/import', formData, {
                headers: {
