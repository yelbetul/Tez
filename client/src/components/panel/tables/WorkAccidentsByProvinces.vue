...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            if (this.state == 'new') {
                axios.post('https://iskazalarianaliz.com/api/work-accidents-by-province/store', this.formData)
                    .then(res => {
                        if (!res.data.success) {
                            this.error = true;
                ...
                axios.put('https://iskazalarianaliz.com/api/work-accidents-by-province/update/' + this.formData.id, this.formData)
                    .then(res => {
                        if (!res.data.success) {
                            this.error = true;
                            this.errorMessage = res.data.message;
