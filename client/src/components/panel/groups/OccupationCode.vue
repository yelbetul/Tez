<template>
    <div v-if="visible" class="modal-overlay" @click.self="closeModal">
        <div class="sector-codes-modal">
            ...
            <h2>Meslek Grubu {{ state === 'new' ? 'Oluştur' : 'Güncelle' }}</h2>
            <form class="form" @submit.prevent="submitForm">
                ...
                <div class="form-element">
                    <label for="occupation_code">Meslek Kodu</label>
                    <input type="text" id="occupation_code" v-model="formData.occupation_code"
                        placeholder="Grup kodu giriniz...">
                </div>
                <div class="form-element">
                    <label for="occupation_name">Meslek Adı</label>
                    <input type="text" id="occupation_name" v-model="formData.occupation_name"
                        placeholder="Meslek adı giriniz...">
                </div>
                <div class="form-element">
