...
class AnalysisHelperAccidentsByGeneralActivities
{
    public static function buildAIPrompt($request, $summary)
    {
        ...
        $activityCode = self::formatRequestInput($request->input('general_activity_code'), 'Tüm faaliyet türleri');

        $prompt = "Aşağıdaki genel faaliyetlere göre iş kazası ve ölüm verilerini ISO 45001 standartlarına uygun teknik raporda analiz et:\n\n";
        ...
        $prompt .= "- Faaliyet Türü: " . self::formatActivityCode($activityCode) . "\n\n";
        ...
        $prompt .= "   - Faaliyet türlerine göre kaza sıklık oranı\n";
                ...
                'messages' => [
                    [
                        ...
                        'content' => "Sen bir ISO 45001 Sertifikalı İş Güvenliği Uzmanısın. "
                            ...
                            . "1. Genel faaliyetlere göre iş kazaları ve ölüm verilerine odaklan\n"
