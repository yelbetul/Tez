...
class AnalysisHelperAccidentsByOccupation
{
    public static function buildAIPrompt($request, $summary)
    {
        ...
        $prompt = "Aşağıdaki meslek gruplarına göre iş kazası ve ölüm verilerini ISO 45001 standartlarına uygun teknik raporda analiz et:\n\n";
        $prompt .= "VERİ PARAMETRELERİ (ISO 45003:2021 Formatında):\n";
        $prompt .= "- Analiz Periyodu: " . self::formatISODateRange($year) . "\n";
        $prompt .= "- Meslek Grubu: " . self::formatOccupationCode($groupCode) . "\n";
        ...
        $prompt .= "   - Mesleklere göre kaza sıklık oranı\n";
        $prompt .= "   - Ölümlü kazalar için kritik risk haritalandırması (5x5 matris)\n";
        $prompt .= "   - İş göremezlik sürelerine göre mesleki risk sıralaması\n\n";

        $prompt .= "2. Kök Neden Analizi (ISO 45002:2016):\n";
        $prompt .= "   - Meslek gruplarına özgü kaza nedenleri (Fishbone diyagramı)\n";
        $prompt .= "   - Ölümlü kazalar için ISCO-08 sınıflandırmasıyla analiz\n\n";

        $prompt .= "3. Demografik Analiz (ILO C161 Uyumlu):\n";
        $prompt .= "   - Mesleklere göre cinsiyet dağılımı\n";
        $prompt .= "   - Ölümlü kazalarda mesleki risk faktörleri\n\n";

        $prompt .= "4. İyileştirme Planı (Hierarchy of Controls):\n";
        $prompt .= "   - Mesleklere özgü mühendislik kontrolleri (EN ISO 12100)\n";
        $prompt .= "   - Kritik meslekler için acil önlem paketleri\n\n";

        $prompt .= "5. Mesleki Risk Projeksiyonu:\n";
        $prompt .= "   - Meslek gruplarına göre 3 yıllık kaza trend analizi\n\n";

        $prompt .= "RAPOR FORMAT KURALLARI:\n";
        $prompt .= "- Tamamen ISO 45001 terminolojisi kullan\n";
        $prompt .= "- Meslek kodlarını ISCO-08 standardına göre belirt\n";
    ...
    public static function getAICommentary($prompt)
    {
        try {
                ...
                'messages' => [
                    [
                        ...
                        'content' => "Sen bir ISO 45001 Sertifikalı İş Güvenliği Uzmanısın. "
                            ...
                            . "1. Mesleki iş kazaları ve ölüm verilerine odaklan\n"
                            . "2. ISCO-08 meslek sınıflandırmasını kullan\n"
            ...
            return "ISO 45001 uyumlu mesleki kaza analizi geçici olarak mevcut değil. Lütfen teknik ekibe bildiriniz.";
        }
    }
