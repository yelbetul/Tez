...
return new class extends Migration
{
    ...
    {
        Schema::create('accidents_and_fatalities_by_injury_causes', function (Blueprint $table) {
            $table->id();
            $table->string('year'); // Yıl
            $table->unsignedBigInteger('group_id'); // İlgili Yaranlanmaya Sebep Olan Olay
            ...
            $table->foreign('group_id')->references('id')->on('injury_causes')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('accidents_and_fatalities_by_injury_causes');
    }
};
