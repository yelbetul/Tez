...
return new class extends Migration
{
    ...
    {
        Schema::create('accidents_and_fatalities_by_employees', function (Blueprint $table) {
            $table->id();
            $table->string('year'); // Yıl
            $table->unsignedBigInteger('group_id'); // İş Yerinde Çalışan Sigortlı Sayısı
            ...
            $table->foreign('group_id')->references('id')->on('employee_groups')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('accidents_and_fatalities_by_employees');
    }
};
