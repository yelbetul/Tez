...
return new class extends Migration
{
    ...
    {
        Schema::create('accidents_and_fatalities_by_employer_durations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('accidents_and_fatalities_by_employer_durations');
    }
};
