...
return new class extends Migration
{
    ...
    {
        Schema::create('accidents_and_fatalities_by_injury_locations', function (Blueprint $table) {
            $table->id();
            $table->string('year'); // Yıl
            $table->unsignedBigInteger('group_id'); // İlgili Yaranın Vücuttaki yeri
            ...
            $table->foreign('group_id')->references('id')->on('injury_locations')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('accidents_and_fatalities_by_injury_locations');
    }
};
