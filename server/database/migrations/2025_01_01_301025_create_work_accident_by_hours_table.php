...
return new class extends Migration
{
    ...
    {
        Schema::create('work_accident_by_hours', function (Blueprint $table) {
            $table->id();
            $table->string('year'); // Yıl
            $table->unsignedBigInteger('group_id'); // İş Kazasının Meydana Geldiği Saat
            ...
            $table->foreign('group_id')->references('id')->on('time_intervals')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('work_accident_by_hours');
    }
};
