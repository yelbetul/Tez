...
return new class extends Migration
{
    ...
    {
        Schema::create('accidents_and_fatalities_by_deviations', function (Blueprint $table) {
            $table->id();
            $table->string('year'); // Yıl
            $table->unsignedBigInteger('group_id'); // Olayı normal seyrinden saptıran kazaya sebebiyet veren olay (Sapma)
            ...
            $table->foreign('group_id')->references('id')->on('deviations')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('accidents_and_fatalities_by_deviations');
    }
};
