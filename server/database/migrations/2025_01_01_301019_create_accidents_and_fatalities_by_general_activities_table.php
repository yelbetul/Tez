...
return new class extends Migration
{
    ...
    {
        Schema::create('accidents_and_fatalities_by_general_activities', function (Blueprint $table) {
            $table->id();
            $table->string('year'); // Yıl
            $table->unsignedBigInteger('group_id'); // Kaza anında yürütmekte olduğu faaliyet
            ...
            $table->foreign('group_id')->references('id')->on('general_activities')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('accidents_and_fatalities_by_general_activities');
    }
};
