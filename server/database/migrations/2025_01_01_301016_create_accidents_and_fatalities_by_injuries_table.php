...
return new class extends Migration
{
    ...
    {
        Schema::create('accidents_and_fatalities_by_injuries', function (Blueprint $table) {
            $table->id();
            $table->string('year'); // Yıl
            $table->unsignedBigInteger('group_id'); // İlgili Yaranın Türü
            ...
            $table->foreign('group_id')->references('id')->on('injury_types')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('accidents_and_fatalities_by_injuries');
    }
};
