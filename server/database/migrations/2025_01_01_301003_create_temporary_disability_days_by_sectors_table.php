...
return new class extends Migration
{
    ...
    {
        Schema::create('temporary_disability_days_by_sectors', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('group_id')->references('id')->on('sector_codes')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('temporary_disability_days_by_sectors');
    }
};
