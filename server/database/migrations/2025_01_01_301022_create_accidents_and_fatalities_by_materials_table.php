...
return new class extends Migration
{
    ...
    {
        Schema::create('accidents_and_fatalities_by_materials', function (Blueprint $table) {
            $table->id();
            $table->string('year'); // Yıl
            $table->unsignedBigInteger('group_id'); // Kullanılan Materyal
            ...
            $table->foreign('group_id')->references('id')->on('materials')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('accidents_and_fatalities_by_materials');
    }
};
